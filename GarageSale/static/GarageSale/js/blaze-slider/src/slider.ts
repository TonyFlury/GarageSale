import { Automata, constructAutomata } from 'blaze-slider/src/automata/automata'
import { DEV, END, START } from 'blaze-slider/src/constants'
import { BlazeConfig, MediaConfig, SlideChangeCallback, Track } from 'blaze-slider/src/types'
import { handleAutoplay } from 'blaze-slider/src/utils/autoplay'
import { createConfig, defaultConfig } from 'blaze-slider/src/utils/config'
import { dragSupport, handlePointerDown, isTouch } from 'blaze-slider/src/utils/drag'
import { updateTransform } from 'blaze-slider/src/utils/methods'
import { handleNavigation } from 'blaze-slider/src/utils/navigation'
import { handlePagination } from 'blaze-slider/src/utils/pagination'
import { scrollNext, scrollPrev } from 'blaze-slider/src/utils/scroll'
