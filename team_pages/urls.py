...
urlpatterns = [
    ...
    path('news/<int:news_id>/delete/', views.NewsDelete.as_view(), name='TeamPagesPublishNews'),
    ...
    path('event/<int:event_id>/sale_location/', views.sales_locations_csv, name='TeamPageEventSaleLocation'),
