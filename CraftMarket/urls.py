...
urlpatterns = [
    ...
    path('<int:event_id>/', views.CraftMarketView.as_view(), name='TeamPages'),
    path('<int:event_id>/create/', views.MarketerCreate.as_view(), name='TeamPagesCreate'),
    path('<int:marketer>/view/', views.MarketerView.as_view(), name='TeamPagesView'),
    path('<int:marketer>/edit/', views.MarketerEdit.as_view(), name='TeamPagesEdit'),
    path('<int:marketer>/confirm/', views.MarketerConfirm.as_view(), name='TeamPagesConfirm'),
    path('<int:marketer>/invite/', views.MarketerInvite.as_view(), name='TeamPagesInvite'),
    path('<int:marketer>/reject/', views.MarketerReject.as_view(), name='TeamPagesReject'),
